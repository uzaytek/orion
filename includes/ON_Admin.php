...
class ON_Admin extends ON_Dao
{
  ...
  public function defaults() {
    ...
    unset($fields['adminpasswd']); // password md5 value doesnt work for us
    return $fields;
  }
  ...
  public function update_form() {
    ...
    $this->form     = new ON_QuickForm('update'); 
    ...
    $this->form->addElement('submit', 'sb', _('Save'), 'class="minput"');    
  }
  ...
  public function setValues(&$values) {
    $this->adminemail   = ON_Filter($values['adminemail']);
    $this->adminpasswd  = ($values['adminpasswd'] != '') ? md5(ON_Filter($values['adminpasswd'])) : $this->adminpasswd;
  }
}
